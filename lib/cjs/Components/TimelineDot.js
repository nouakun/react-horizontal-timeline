...
var TimelineDot = /** @class */ (function (_super) {
    ...
    function TimelineDot() {
        ...
        _this.__getDotStyles__ = function (dotType, key) {
            ...
            return [
                ...
                radium_1.default.getState(_this.state, key, ":hover") ||
                    radium_1.default.getState(_this.state, "dot-dot", ":hover")
                    ? hoverStyle
                    : undefined,
            ];
        };
    ...
    TimelineDot.prototype.render = function () {
        ...
        return (react_1.default.createElement("li", { key: this.props.date, id: "timeline-dot-" + this.props.date, className: dotType + " dot-label", onClick: function () { return onClick(index); }, style: helpers_1.asCSS([
                dots.links,
                {
                    cursor: "pointer",
                ...
                (_a = {},
                    _a[isRtl ? Constants_1.default.RIGHT : Constants_1.default.LEFT] = isRtl
                        ? distanceFromOrigin - labelWidth / 2
                        : distanceFromOrigin - labelWidth / 2,
                    _a),
            ]) },
            this.props.label,
            react_1.default.createElement("span", { key: "dot-dot", style: helpers_1.asCSS(this.__getDotStyles__(dotType, date)) })));
    };
    return TimelineDot;
}(react_1.default.Component));
exports.default = radium_1.default(TimelineDot);
