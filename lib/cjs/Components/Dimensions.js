        ...
        return /** @class */ (function (_super) {
            ...
            function DimensionsHOC(props) {
                ...
                _this.updateDimensions = debounce === 0 ? _this.updateDimensionsImmediate
                    : lodash_1.debounce(_this.updateDimensionsImmediate, debounce, debounceOpts);
                ...
                if (elementResize) {
                    ...
                    element_resize_event_1.default(_this._parent, _this.updateDimensions);
                }
                else {
            ...
            DimensionsHOC.prototype.render = function () {
                ...
                return (react_1.default.createElement("div", { style: wrapperStyle, ref: this.wrapper }, (containerWidth || containerHeight) &&
                    react_1.default.createElement(ComposedComponent, __assign({}, state, props, { updateDimensions: updateDimensions, ref: 'wrappedInstance' }))));
            };
