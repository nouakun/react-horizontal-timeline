...
var faderStyle = {
    ...
    specific: function (styles, position, gradientDirection) {
        ...
        return (_a = {},
            _a[position] = 40,
            _a.backgroundImage = "linear-gradient(to " + gradientDirection + ", " + styles.background + ", " + color_1.default(styles.background).alpha(0).rgb() + ")",
            _a);
    },
};
/**
 ...
 */
var Faders = function (props) { return (react_1.default.createElement("ul", { style: { listStyle: "none" } },
