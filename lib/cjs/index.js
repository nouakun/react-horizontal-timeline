...
var Index = /** @class */ (function (_super) {
    ...
    Index.prototype.render = function () {
        var _this = this;
        var _a = this.props, values = _a.values, labelWidth = _a.labelWidth, minEventPadding = _a.minEventPadding, maxEventPadding = _a.maxEventPadding, linePadding = _a.linePadding, getLabel = _a.getLabel, isTouchEnabled = _a.isTouchEnabled, styles = _a.styles, fillingMotion = _a.fillingMotion, indexClick = _a.indexClick, index = _a.index, isRtl = _a.isRtl;
